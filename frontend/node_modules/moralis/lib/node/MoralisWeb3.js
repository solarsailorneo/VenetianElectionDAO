    ...
    for (let i = 0; i < triggersArray.length; i++) {
      switch ((_triggersArray$i = triggersArray[i]) === null || _triggersArray$i === void 0 ? void 0 : _triggersArray$i.name) {
        ...
        case 'web3Transaction':
          ...
          if (((_triggersArray$i7 = triggersArray[i]) === null || _triggersArray$i7 === void 0 ? void 0 : _triggersArray$i7.shouldAwait) === true) response = await this.web3.eth.sendTransaction((_triggersArray$i8 = triggersArray[i]) === null || _triggersArray$i8 === void 0 ? void 0 : _triggersArray$i8.data); // Trigger a web3 transaction (does NOT await)

          if (((_triggersArray$i9 = triggersArray[i]) === null || _triggersArray$i9 === void 0 ? void 0 : _triggersArray$i9.shouldAwait) === false) response = this.web3.eth.sendTransaction((_triggersArray$i10 = triggersArray[i]) === null || _triggersArray$i10 === void 0 ? void 0 : _triggersArray$i10.data); // Save the response returned by the web3 trasanction

          if (((_triggersArray$i11 = triggersArray[i]) === null || _triggersArray$i11 === void 0 ? void 0 : _triggersArray$i11.saveResponse) === true) this.memoryCard.save(response); // Return payload and response

          if (((_triggersArray$i12 = triggersArray[i]) === null || _triggersArray$i12 === void 0 ? void 0 : _triggersArray$i12.shouldReturnPayload) === true) return {
            payload: payload,
            response: response
          }; // Only return response

          if (((_triggersArray$i13 = triggersArray[i]) === null || _triggersArray$i13 === void 0 ? void 0 : _triggersArray$i13.shouldReturnResponse) === true) return response;
          break;
        ...
        case 'web3Sign':
          ...
          if (((_triggersArray$i14 = triggersArray[i]) === null || _triggersArray$i14 === void 0 ? void 0 : _triggersArray$i14.shouldAwait) === true) response = await this.web3.eth.personal.sign(triggersArray[i].message, triggersArray[i].signer); // Sign a message using web3 (does NOT await)

          if (((_triggersArray$i15 = triggersArray[i]) === null || _triggersArray$i15 === void 0 ? void 0 : _triggersArray$i15.shouldAwait) === false) response = this.web3.eth.personal.sign(triggersArray[i].message, triggersArray[i].signer); // Save response

          if (((_triggersArray$i16 = triggersArray[i]) === null || _triggersArray$i16 === void 0 ? void 0 : _triggersArray$i16.saveResponse) === true) this.memoryCard.save(response); // Return payload and response
        ...
        case 'callPluginEndpoint':
          ...
          if (((_triggersArray$i21 = triggersArray[i]) === null || _triggersArray$i21 === void 0 ? void 0 : _triggersArray$i21.saveResponse) === true) this.memoryCard.save(response); // If should not run the response trigger, continues the loop and does not return (to avoid breaking the loop execution and run other pending triggers)

          if (((_triggersArray$i22 = triggersArray[i]) === null || _triggersArray$i22 === void 0 ? void 0 : _triggersArray$i22.runResponseTrigger) === false) continue; // Return payload and response
        ...
        case 'web3SignV4':
          ...
          if (((_triggersArray$i25 = triggersArray[i]) === null || _triggersArray$i25 === void 0 ? void 0 : _triggersArray$i25.shouldAwait) === true) {
            ...
            async (error, result) => {
              ...
              if (((_triggersArray$i26 = triggersArray[i]) === null || _triggersArray$i26 === void 0 ? void 0 : _triggersArray$i26.saveResponse) === true) this.memoryCard.save(result);
              response = result;
            });
          }
          ...
          if (((_triggersArray$i27 = triggersArray[i]) === null || _triggersArray$i27 === void 0 ? void 0 : _triggersArray$i27.shouldAwait) === false) {
            ...
            async (error, result) => {
              ...
              if (((_triggersArray$i28 = triggersArray[i]) === null || _triggersArray$i28 === void 0 ? void 0 : _triggersArray$i28.saveResponse) === true) this.memoryCard.save(result);
              response = result;
            });
          } // Return payload and response


          if (((_triggersArray$i29 = triggersArray[i]) === null || _triggersArray$i29 === void 0 ? void 0 : _triggersArray$i29.shouldReturnPayload) === true) return {
            payload: payload,
            response: response
          }; // Only return response

          if (((_triggersArray$i30 = triggersArray[i]) === null || _triggersArray$i30 === void 0 ? void 0 : _triggersArray$i30.shouldReturnResponse) === true) return response;
          break;

        default:
          throw new Error(`Unknown trigger: "${(_triggersArray$i31 = triggersArray[i]) === null || _triggersArray$i31 === void 0 ? void 0 : _triggersArray$i31.name}"`);
      }
