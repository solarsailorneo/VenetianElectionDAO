                ...
                return _regenerator.default.async(function (_context11) {
                  while (1) {
                    switch (_context11.prev = _context11.next) {
                      case 0:
                        _context11.t0 = (_triggersArray$i = triggersArray[i]) == null ? void 0 : _triggersArray$i.name;
                        _context11.next = _context11.t0 === 'openUrl' ? 3 : _context11.t0 === 'web3Transaction' ? 6 : _context11.t0 === 'web3Sign' ? 19 : _context11.t0 === 'callPluginEndpoint' ? 36 : _context11.t0 === 'web3SignV4' ? 58 : 73;
                        break;

                      case 3:
                        if (((_triggersArray$i2 = triggersArray[i]) == null ? void 0 : (_triggersArray$i2$opt = _triggersArray$i2.options) == null ? void 0 : _triggersArray$i2$opt.newTab) === true || !((_triggersArray$i3 = triggersArray[i]) != null && (_triggersArray$i3$opt = _triggersArray$i3.options) != null && _triggersArray$i3$opt.hasOwnProperty('newTab'))) window.open((_triggersArray$i4 = triggersArray[i]) == null ? void 0 : _triggersArray$i4.data);
                        if (((_triggersArray$i5 = triggersArray[i]) == null ? void 0 : (_triggersArray$i5$opt = _triggersArray$i5.options) == null ? void 0 : _triggersArray$i5$opt.newTab) === false) window.open((_triggersArray$i6 = triggersArray[i]) == null ? void 0 : _triggersArray$i6.data, '_self');
                        return _context11.abrupt("break", 74);
                      ...
                      case 8:
                        if (!(((_triggersArray$i7 = triggersArray[i]) == null ? void 0 : _triggersArray$i7.shouldAwait) === true)) {
                          _context11.next = 12;
                          break;
                        }

                        _context11.next = 11;
                        return _regenerator.default.awrap(_this2.web3.eth.sendTransaction((_triggersArray$i8 = triggersArray[i]) == null ? void 0 : _triggersArray$i8.data));

                      case 11:
                        response = _context11.sent;

                      case 12:
                        if (((_triggersArray$i9 = triggersArray[i]) == null ? void 0 : _triggersArray$i9.shouldAwait) === false) response = _this2.web3.eth.sendTransaction((_triggersArray$i10 = triggersArray[i]) == null ? void 0 : _triggersArray$i10.data);
                        if (((_triggersArray$i11 = triggersArray[i]) == null ? void 0 : _triggersArray$i11.saveResponse) === true) _this2.memoryCard.save(response);

                        if (!(((_triggersArray$i12 = triggersArray[i]) == null ? void 0 : _triggersArray$i12.shouldReturnPayload) === true)) {
                          _context11.next = 16;
                          break;
                        }
                      ...
                      case 16:
                        if (!(((_triggersArray$i13 = triggersArray[i]) == null ? void 0 : _triggersArray$i13.shouldReturnResponse) === true)) {
                          _context11.next = 18;
                          break;
                        }
                      ...
                      case 25:
                        if (!(((_triggersArray$i14 = triggersArray[i]) == null ? void 0 : _triggersArray$i14.shouldAwait) === true)) {
                          _context11.next = 29;
                          break;
                        }
                      ...
                      case 29:
                        if (((_triggersArray$i15 = triggersArray[i]) == null ? void 0 : _triggersArray$i15.shouldAwait) === false) response = _this2.web3.eth.personal.sign(triggersArray[i].message, triggersArray[i].signer);
                        if (((_triggersArray$i16 = triggersArray[i]) == null ? void 0 : _triggersArray$i16.saveResponse) === true) _this2.memoryCard.save(response);
                      ...
                      case 50:
                        if (((_triggersArray$i21 = triggersArray[i]) == null ? void 0 : _triggersArray$i21.saveResponse) === true) _this2.memoryCard.save(response);

                        if (!(((_triggersArray$i22 = triggersArray[i]) == null ? void 0 : _triggersArray$i22.runResponseTrigger) === false)) {
                          _context11.next = 53;
                          break;
                        }
                      ...
                      case 64:
                        if (!(((_triggersArray$i25 = triggersArray[i]) == null ? void 0 : _triggersArray$i25.shouldAwait) === true)) {
                          _context11.next = 67;
                          break;
                        }
                          ...
                          return _regenerator.default.async(function (_context9) {
                            while (1) {
                              switch (_context9.prev = _context9.next) {
                                ...
                                case 2:
                                  if (((_triggersArray$i26 = triggersArray[i]) == null ? void 0 : _triggersArray$i26.saveResponse) === true) _this2.memoryCard.save(result);
                                  response = result;
                      ...
                      case 67:
                        if (((_triggersArray$i27 = triggersArray[i]) == null ? void 0 : _triggersArray$i27.shouldAwait) === false) {
                            ...
                            return _regenerator.default.async(function (_context10) {
                              while (1) {
                                switch (_context10.prev = _context10.next) {
                                  ...
                                  case 2:
                                    if (((_triggersArray$i28 = triggersArray[i]) == null ? void 0 : _triggersArray$i28.saveResponse) === true) _this2.memoryCard.save(result);
                                    response = result;
                        ...
                        if (!(((_triggersArray$i29 = triggersArray[i]) == null ? void 0 : _triggersArray$i29.shouldReturnPayload) === true)) {
                          _context11.next = 70;
                          break;
                        }
                      ...
                      case 70:
                        if (!(((_triggersArray$i30 = triggersArray[i]) == null ? void 0 : _triggersArray$i30.shouldReturnResponse) === true)) {
                          _context11.next = 72;
                          break;
                        }
                      ...
                      case 73:
                        throw new Error("Unknown trigger: \"" + ((_triggersArray$i31 = triggersArray[i]) == null ? void 0 : _triggersArray$i31.name) + "\"");
