...
var _useMoralisInit = function (_a) {
    var appId = _a.appId, serverUrl = _a.serverUrl, jsKey = _a.jsKey, dangerouslyUseOfMasterKey = _a.dangerouslyUseOfMasterKey, plugins = _a.plugins, _b = _a.environment, environment = _b === void 0 ? "browser" : _b, _c = _a.getMoralis, getMoralis = _c === void 0 ? function () { return MoralisImport__default["default"]; } : _c;
...
var _useMoralisWeb3 = function (Moralis) {
    var _a = react$1.useState(new Moralis.Web3()), web3 = _a[0], setWeb3 = _a[1];
    var _b = react$1.useState(false), isWeb3Enabled = _b[0], setIsWeb3Enabled = _b[1];
    var _c = react$1.useState(null), web3EnableError = _c[0], setEnableWeb3Error = _c[1];
    var _d = react$1.useState(false), isWeb3EnableLoading = _d[0], setIsWeb3EnableLoading = _d[1];
    var _e = react$1.useState(null), account = _e[0], setAccount = _e[1];
    var _f = react$1.useState(null), chainId = _f[0], setChainId = _f[1];
    ...
    react$1.useEffect(function () { var _a; return setChainId((_a = web3 === null || web3 === void 0 ? void 0 : web3.givenProvider) === null || _a === void 0 ? void 0 : _a.chainId); });
    react$1.useEffect(function () { var _a; return setAccount((_a = web3 === null || web3 === void 0 ? void 0 : web3.givenProvider) === null || _a === void 0 ? void 0 : _a.selectedAddress); }, [web3]);
    /**
...
var MoralisProvider = function (_a) {
    ...
    return (jsxRuntime.jsx(MoralisContext.Provider, __assign({ value: __assign(__assign(__assign(__assign({}, moralisInit), moralisAuth), moralisUser), moralisWeb3) }, { children: children }), void 0));
};
