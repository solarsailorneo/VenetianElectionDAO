...
var ReactMoralisError = /** @class */ (function (_super) {
    ...
    function ReactMoralisError(message) {
        var _this = _super.call(this, "[react-moralis]: " + message) || this;
...
var useChain = function () {
    var _a = useMoralis(), Moralis = _a.Moralis, chainId = _a.chainId, account = _a.account;
    var switchNetwork = function (providedChainId) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 6]);
                    return [4 /*yield*/, Moralis.Web3.switchNetwork(providedChainId)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 2:
                    ...
                    if (!chainData) {
                        throw new Error("Chain " + providedChainId + " not supported or is not specified");
                    }
                    ...
                    return [4 /*yield*/, Moralis.Web3.addNetwork(chainId_1, name_1, nativeCurrency.name, nativeCurrency.symbol, rpc[0], blockExplorerUrl !== null && blockExplorerUrl !== void 0 ? blockExplorerUrl : "")];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
    ...
    return { switchNetwork: switchNetwork, chainId: chainId, chain: chain, account: account };
};
...
var _useMoralisAuth = function (options) {
    var _a = __assign(__assign({}, defaultUseMoralisAuthOptions(options.Moralis)), options), onAccountChanged = _a.onAccountChanged, Moralis = _a.Moralis, environment = _a.environment;
...
var _useMoralisInit = function (_a) {
    var appId = _a.appId, serverUrl = _a.serverUrl, jsKey = _a.jsKey, dangerouslyUseOfMasterKey = _a.dangerouslyUseOfMasterKey, plugins = _a.plugins, _b = _a.environment, environment = _b === void 0 ? "browser" : _b, _c = _a.getMoralis, getMoralis = _c === void 0 ? function () { return MoralisImport; } : _c;
...
var _useMoralisWeb3 = function (Moralis) {
    var _a = useState(new Moralis.Web3()), web3 = _a[0], setWeb3 = _a[1];
    var _b = useState(false), isWeb3Enabled = _b[0], setIsWeb3Enabled = _b[1];
    var _c = useState(null), web3EnableError = _c[0], setEnableWeb3Error = _c[1];
    var _d = useState(false), isWeb3EnableLoading = _d[0], setIsWeb3EnableLoading = _d[1];
    var _e = useState(null), account = _e[0], setAccount = _e[1];
    var _f = useState(null), chainId = _f[0], setChainId = _f[1];
    ...
    useEffect(function () {
        ...
        Moralis.Web3.onAccountsChanged(function (accounts) {
            var account = accounts && accounts[0] ? accounts[0] : null;
            setAccount(account);
        });
        return function () {
    ...
    useEffect(function () { var _a; return setChainId((_a = web3 === null || web3 === void 0 ? void 0 : web3.givenProvider) === null || _a === void 0 ? void 0 : _a.chainId); });
    useEffect(function () { var _a; return setAccount((_a = web3 === null || web3 === void 0 ? void 0 : web3.givenProvider) === null || _a === void 0 ? void 0 : _a.selectedAddress); }, [web3]);
    /**
    ...
    var enableWeb3 = useCallback(function (_a) {
        var _b = _a === void 0 ? {} : _a, throwOnError = _b.throwOnError, onComplete = _b.onComplete, onError = _b.onError, onSuccess = _b.onSuccess, provider = _b.provider, chainId = _b.chainId;
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, Moralis.Web3.enable(__assign(__assign({}, (!!provider && { provider: provider })), (!!chainId && { chainId: chainId })))];
                    case 2:
                        currentWeb3 = _c.sent();
                        setWeb3(currentWeb3);
...
var MoralisProvider = function (_a) {
    var children = _a.children, appId = _a.appId, jsKey = _a.jsKey, dangerouslyUseOfMasterKey = _a.dangerouslyUseOfMasterKey, serverUrl = _a.serverUrl, plugins = _a.plugins, environment = _a.environment, getMoralis = _a.getMoralis, _b = _a.options, _c = _b === void 0 ? {} : _b, onAccountChanged = _c.onAccountChanged;
    ...
    var _d = _useMoralisUser(moralisInit.Moralis), setUser = _d.setUser, moralisUser = __rest(_d, ["setUser"]);
    ...
    var moralisWeb3 = _useMoralisWeb3(moralisInit.Moralis);
    return (jsx(MoralisContext.Provider, __assign({ value: __assign(__assign(__assign(__assign({}, moralisInit), moralisAuth), moralisUser), moralisWeb3) }, { children: children }), void 0));
};
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Moralis.Web3.executeFunction(allParams)];
                case 1: 
                //@ts-ignore
    ...
    var call = useCallback(function (callParams) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    allParams = __assign(__assign({}, params), callParams);
                    return [4 /*yield*/, Moralis.Web3.transfer(allParams)];
                case 1: 
                //@ts-ignore
                return [2 /*return*/, _a.sent()];
            }
...
var useOneInchQuote = function (params, options) {
    ...
    if (options === void 0) { options = {}; }
    var Moralis = useMoralis().Moralis;
    var _d = _useResolvePluginCall(Plugin.ONE_INCH, (_b = (_a = Moralis.Plugins) === null || _a === void 0 ? void 0 : _a.oneInch) === null || _b === void 0 ? void 0 : _b.quote, null, {
        chain: (_c = params.chain) !== null && _c !== void 0 ? _c : DEFAULT_API_CHAIN,
...
export { ByMoralis, MoralisContext, MoralisProvider, NoMoralisContextProviderError, NotAuthenticatedError, ReactMoralisError, ValidationError, getChain, getSupportedChains, resolveIPFS, useApiContract, useChain, useERC20Balances, useERC20Transfers, useMoralis, useMoralisCloudFunction, useMoralisFile, useMoralisQuery, useMoralisSubscription, useMoralisWeb3Api, useMoralisWeb3ApiCall, useNFTBalances, useNFTTransfers, useNativeBalance, useNativeTransactions, useNewMoralisObject, useOneInchQuote, useOneInchSwap, useOneInchTokens, useTokenPrice, useWeb3Contract, useWeb3ExecuteFunction, useWeb3Transfer };
